...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-4">
				<a class="btn btn-default btn-lg btn-block" role="button" href="list.bit">리스트</a> 
				<a class="btn btn-primary btn-lg btn-block" role="button" href="add.bit">글쓰기</a>
			</div>
			<div class="col-md-8">
